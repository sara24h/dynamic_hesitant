# dynamic_hesitant/models/hesitant_fuzzy.py
...
class HesitantFuzzyMembership(nn.Module):
    """
    Generates hesitant fuzzy membership values for model selection.
    """
...
class MultiModelNormalization(nn.Module):
    """
    Applies different normalization parameters for each model in the ensemble.
    """
